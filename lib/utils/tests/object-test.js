...
describe('# Object Utils', () => {
    ...
    it('Test ObjectUtill::merge', () => {
        ...
        const imutableApiOptions = objectUtil.merge(defaultApiOptions, moduleApiOptions, true);
        ...
        const mutableApiOptions = objectUtil.merge(defaultApiOptions, moduleApiOptions);
