    ...
    it('Test Middleware::sanitizeRequest', (done) => {
        ...
        sanitizeMiddleware(req, {}, () => {
            try {
                ...
                assert.equal(req.params.number, 123);
                assert.equal(req.params.bool, true);
                assert.equal(req.params.nil, null);
                assert.equal(req.params.flasy, false);
                assert.equal(req.params.undfn, undefined);
            } catch (e) {
                return done(e);
            }
