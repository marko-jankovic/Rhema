...
const urlGenerator = require('@rhema/formatUrl');
const pageType = require('@rhema/middleware/lib/core/pageType');
const reqData = require('@rhema/middleware/lib/core/reqData');
const removeParamPrefix = require('@rhema/middleware/lib/core/removeParamPrefix');
const removeParamsPrefixes = require('@rhema/middleware/lib/core/removeParamsPrefixes');
const requestTimeout = require('@rhema/middleware/lib/core/requestTimeout');
            ...
            if (!controllerResolver) {
                ...
                router[routeMethod](
                    ...
                    (req, res, next) => {
                        ...
                        // </form>
                        const actionType = route.action || routeOptions.method || routeMethod;

                        // get Controller Action
                        const action = controller.use(actionType, route.pageType);
