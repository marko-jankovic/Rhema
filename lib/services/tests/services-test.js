        ...
        instance = services.create({
            ...
            app: {
                services: {
                    formatters: {
                        seo: {
                            path: './lib/services/tests/test-services/seo.js'
                        }
                    },
                    helpers: {
                        string: {
                            path: './lib/services/tests/test-services/string.js'
                        }
                    },
                    gateway: {
                        initial: {
                            path: './lib/services/tests/test-services/initial.js'
                        }
                    },
                    export: {
                        test1: {
                            path: './lib/services/tests/test-services/export1.js',
                            method: 'get'
                        },
                        test2: {
                            path: './lib/services/tests/test-services/export2.js',
                            method: 'get'
                        }
                    },
                    simple: {
                        test1: {
                            path: './lib/services/tests/test-services/simple.js'
                        },
                        test2: {
                            path: './lib/services/tests/test-services/simple2.js'
                        },
                        test3: {
                            path: './lib/services/tests/test-services/simple3.js'
                        }
                    },
                    prototype: {
                        prototype1: {
                            path: './lib/services/tests/test-services/prototype1.js'
                        },
                        prototype2: {
                            path: './lib/services/tests/test-services/prototype2.js'
                        }
                    }
                }
            }
